function updatedCellArray = AddToCellArrayStringValues(cellArray, scaler, operator)
    % AddToCellArrayStringValues Apply an arithmetic operation to a cell array of string numbers
    %
    % Syntax:
    %   updatedCellArray = Utils.AddToCellArrayStringValues(cellArray, scaler, operator)
    %
    % Inputs:
