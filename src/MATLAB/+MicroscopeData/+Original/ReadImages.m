function [ seriesImages ] = ReadImages( dirIn, fileNameIn, seriesNum, varargin )
...
seriesImages = MicroscopeData.Original.BioFormats.GetImages(bfReader,seriesNum, varargin{:});
